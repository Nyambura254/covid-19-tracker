...
// https://disease.sh/v3/covid-19/countries/Kenya?yesterday=true&twoDaysAgo=true&strict=true&allowNull=false
  ...
  .then((data) => {
    ...
    let myChart = new Chart(ctx, {
      ...
      options: {
        ...
        title: {
          display: true,
          text: `Coronovirus Cases in World for the last 10 days`,
        },
      },
    });
  })
